#!/usr/bin/env bash
#
# convert.sh — Convert agent .md files into tool-specific formats (Indonesian edition)
#
...
# source：https://github.com/jnMetaCode/agency-agents-id
#
